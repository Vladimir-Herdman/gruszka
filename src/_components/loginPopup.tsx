    ...
    <>
      <div className={styles.background}>
        <div className={styles.loginContainer}>
          ...
          <InputRow title="Password" setFunc={setPassword} />
...
function InputRow({title, placeholder, setFunc}: InputBarProps) {
  return (
